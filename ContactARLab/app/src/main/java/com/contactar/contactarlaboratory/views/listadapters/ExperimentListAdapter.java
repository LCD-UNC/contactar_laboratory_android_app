package com.contactar.contactarlaboratory.views.listadapters;
...
import com.contactar.contactarlaboratory.views.ExperimentDetailActivity;

import java.util.List;

public class ExperimentListAdapter extends RecyclerView.Adapter<ExperimentListAdapter.ExperimentViewHolder> {

    public static final String EXTRA_ID = "com.contactar.contactarlaboratory.ID";
