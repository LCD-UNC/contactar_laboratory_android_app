...
import com.contactar.digitriadlaboratory.export.representations.DeviceRepresentation;

import java.util.Date;
import java.util.UUID;

import static com.contactar.digitriadlaboratory.advertisers.BluetoothLeAdvertiseScheduler.EXPERIMENT_SERVICE_UUID;
