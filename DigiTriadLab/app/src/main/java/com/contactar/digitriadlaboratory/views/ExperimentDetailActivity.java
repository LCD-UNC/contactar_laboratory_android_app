...
import com.contactar.digitriadlaboratory.MainActivity;
...
import com.contactar.digitriadlaboratory.export.csv.ActivityCsvFileWriter;
import com.contactar.digitriadlaboratory.export.csv.BatteryCsvFileWriter;
import com.contactar.digitriadlaboratory.export.csv.BluetoothCsvFileWriter;
import com.contactar.digitriadlaboratory.export.csv.BluetoothLeCsvFileWriter;
import com.contactar.digitriadlaboratory.export.csv.CellCsvFileWriter;
import com.contactar.digitriadlaboratory.export.csv.GpsCsvFileWriter;
import com.contactar.digitriadlaboratory.export.csv.SensorCsvFileWriter;
import com.contactar.digitriadlaboratory.export.csv.WifiCsvFileWriter;
import com.contactar.digitriadlaboratory.export.json.JsonExperimentFileWriter;
import com.contactar.digitriadlaboratory.gapis.GoogleSessionAppCompatActivity;
import com.contactar.digitriadlaboratory.gapis.drive.DriveServiceHelper;
import com.contactar.digitriadlaboratory.gapis.drive.folderselector.FolderPickerActivity;
import com.contactar.digitriadlaboratory.views.listadapters.ExperimentListAdapter;
import com.contactar.digitriadlaboratory.views.listadapters.RunListAdapter;
import com.contactar.digitriadlaboratory.views.modelviews.ExperimentDetailViewModel;
import com.contactar.digitriadlaboratory.repositories.DeviceRepository;

import java.util.List;

import static com.contactar.digitriadlaboratory.gapis.GoogleServicesHelper.REQUEST_CODE_SIGN_IN;

public class ExperimentDetailActivity extends GoogleSessionAppCompatActivity {

    private static final String EXTRA_ID = "com.contactar.digitriadlaboratory.ID";
    ...
    public void exportData() {
        ...
        if (experimentDetailViewModel.getModules().contains(SourceTypeEnum.BATTERY.name()))
            new BatteryCsvFileWriter(runs, database, context).execute();

        if (experimentDetailViewModel.getModules().contains(SourceTypeEnum.ACTIVITY.name()))
