...
public class ShareTools {
    ...
    public static Bitmap getQrExperiment(Experiment experiment,
        ...
        ExperimentRepresentation codedExperimentObject = new ExperimentRepresentation(experiment,
                wifiWindow, bluetoothWindow, bluetoothLeWindow, sensorWindow, advertiseWindow,
                advertiseConfiguration, tagList, null);
        Gson gson = new Gson();
